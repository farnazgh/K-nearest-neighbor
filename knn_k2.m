...
for i=1:30
  ...
  for j=1:num_test_data
    ...
    if ((train_data(first_nearest_sample_index ,1) == train_data(second_nearest_sample_index ,1))&&(sample(1) == train_data(first_nearest_sample_index ,1))) || ((train_data(first_nearest_sample_index ,1) ~= train_data(second_nearest_sample_index ,1))&&(sample(1) == train_data(first_nearest_sample_index ,1))) 
